...
export function ProductsSection() {
  ...
  const validProductIndex =
    products.length > 0 ? Math.min(currentPackIndex, products.length - 1) : 0;
  ...
  const currentProduct =
    products.length > 0 ? products[validProductIndex] : null;
                      ...
                      {currentProduct ? (
                        ...
                        >
                          <span className="text-primary text-sm font-light tracking-widest uppercase">
                            {currentProduct.category || "Premium Collection"}
                          </span>
